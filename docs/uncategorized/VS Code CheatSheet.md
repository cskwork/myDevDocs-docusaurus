...
description: "Ctrl+Shift+P, F1  Show Command PaletteCtrl+P Quick Open, Go to FileCtrl+Shift+N New windowinstanceCtrl+W Close windowinstanceCtrl+, User Settin"
