...
description: "가장 기본적인 자료구조인 Array 자료구조는, 논리적 저장 순서와 물리적 저장 순서가 일치한다. 따라서 인덱스index로 해당 원소element에 접근할 수 있다. 그렇기 때문에 찾고자 하는 원소의 인덱스 값을 알고 있으면 Big-O1에 해당 원소로 접근할"
...
### 해시충돌(collision-해결방법)
![](/velogimages/649f6319-d29d-4a98-8a52-9e0408ac0fdf-image.png)
